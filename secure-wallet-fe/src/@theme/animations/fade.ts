...
import { ThemeAnimationCurves, ThemeAnimationDurations } from '@theme/animations/defaults';
...
const fadeIn = trigger('fadeIn',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${ThemeAnimationDurations.entering} ${ThemeAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const fadeOut = trigger('fadeOut',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${ThemeAnimationDurations.exiting} ${ThemeAnimationCurves.acceleration}`
                }
            }
        )
    ]
