...
import { ThemeMockApiReplyCallback } from '@theme/lib/mock-api/mock-api.types';

export class ThemeMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: ThemeMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: ThemeMockApiReplyCallback): void
    {
        // Store the reply
