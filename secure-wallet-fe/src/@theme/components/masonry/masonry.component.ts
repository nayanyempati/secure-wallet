...
import { ThemeMediaWatcherService } from '@theme/services/media-watcher';

@Component({
    selector     : 'theme-masonry',
    templateUrl  : './masonry.component.html',
    encapsulation: ViewEncapsulation.None,
    animations   : themeAnimations,
    exportAs     : 'themeMasonry'
})
export class ThemeMasonryComponent implements OnChanges, AfterViewInit
{
