...
import { FSDocument, FSDocumentElement } from '@theme/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'theme-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'themeFullscreen'
})
export class ThemeFullscreenComponent implements OnInit
{
