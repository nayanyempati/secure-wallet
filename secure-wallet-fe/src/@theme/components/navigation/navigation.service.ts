...
export class ThemeNavigationService
{
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, ThemeNavigationItem[]> = new Map<string, any>();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: ThemeNavigationItem[]): void
    {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): ThemeNavigationItem[]
    {
     ...
     */
    getFlatNavigation(navigation: ThemeNavigationItem[], flatNavigation: ThemeNavigationItem[] = []): ThemeNavigationItem[]
    {
     ...
     * @param navigation
     */
    getItem(id: string, navigation: ThemeNavigationItem[]): ThemeNavigationItem | null
    {
        for ( const item of navigation )
        {
            if ( item.id === id )
    ...
    getItemParent(
        ...
        parent: ThemeNavigationItem[] | ThemeNavigationItem
    ): ThemeNavigationItem[] | ThemeNavigationItem | null
    {
        for ( const item of navigation )
        {
            if ( item.id === id )
