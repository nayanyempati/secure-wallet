...
import { ThemeNavigationItem, ThemeVerticalNavigationAppearance, ThemeVerticalNavigationMode, ThemeVerticalNavigationPosition } from '@theme/components/navigation/navigation.types';
...
@Component({
    selector       : 'theme-vertical-navigation',
    templateUrl    : './vertical.component.html',
    styleUrls      : ['./vertical.component.scss'],
    animations     : themeAnimations,
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'themeVerticalNavigation'
})
export class ThemeVerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    @Input() appearance: ThemeVerticalNavigationAppearance = 'default';
    @Input() autoCollapse: boolean = true;
    @Input() inner: boolean = false;
    @Input() mode: ThemeVerticalNavigationMode = 'side';
    @Input() name: string = this._themeUtilsService.randomId();
    @Input() navigation: ThemeNavigationItem[];
    @Input() opened: boolean = true;
    @Input() position: ThemeVerticalNavigationPosition = 'left';
    @Input() transparentOverlay: boolean = false;
    @Output() readonly appearanceChanged: EventEmitter<ThemeVerticalNavigationAppearance> = new EventEmitter<ThemeVerticalNavigationAppearance>();
    @Output() readonly modeChanged: EventEmitter<ThemeVerticalNavigationMode> = new EventEmitter<ThemeVerticalNavigationMode>();
    @Output() readonly openedChanged: EventEmitter<boolean> = new EventEmitter<boolean>();
    @Output() readonly positionChanged: EventEmitter<ThemeVerticalNavigationPosition> = new EventEmitter<ThemeVerticalNavigationPosition>();
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'theme-vertical-navigation-animations-enabled'             : this._animationsEnabled,
            [`theme-vertical-navigation-appearance-${this.appearance}`]: true,
            'theme-vertical-navigation-hover'                          : this._hovered,
            'theme-vertical-navigation-inner'                          : this.inner,
            'theme-vertical-navigation-mode-over'                      : this.mode === 'over',
            'theme-vertical-navigation-mode-side'                      : this.mode === 'side',
            'theme-vertical-navigation-opened'                         : this.opened,
            'theme-vertical-navigation-position-left'                  : this.position === 'left',
            'theme-vertical-navigation-position-right'                 : this.position === 'right'
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    set themeScrollbarDirectives(themeScrollbarDirectives: QueryList<ThemeScrollbarDirective>)
    {
        ...
        this._themeScrollbarDirectivesSubscription =
            merge(
    ...
    ngAfterViewInit(): void
    {
        ...
        setTimeout(() => {
            ...
            if ( !this._navigationContentEl.nativeElement.classList.contains('ps') )
            {
                ...
                const activeItem = this._navigationContentEl.nativeElement.querySelector('.theme-vertical-navigation-item-active');
            ...
            else
            {
                ...
                this._themeScrollbarDirectives.forEach((themeScrollbarDirective) => {
                    ...
                    themeScrollbarDirective.scrollToElement('.theme-vertical-navigation-item-active', -120, true);
                });
            }
        });
    }
    ...
    private _showOverlay(): void
    {
        ...
        this._overlay.classList.add('theme-vertical-navigation-overlay');

        // Add a class depending on the transparentOverlay option
        if ( this.transparentOverlay )
        {
            this._overlay.classList.add('theme-vertical-navigation-overlay-transparent');
        }
    ...
    private _showAsideOverlay(): void
    {
        ...
        this._asideOverlay.classList.add('theme-vertical-navigation-aside-overlay');
