...
@Component({
    selector       : 'theme-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : themeAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ThemeVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'theme-vertical-navigation-item-collapsed': this.isCollapsed,
            'theme-vertical-navigation-item-expanded' : this.isExpanded
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void
    {
        ...
        this._themeVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._themeVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._themeVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._themeVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _isChildrenOf(parent: ThemeNavigationItem, item: ThemeNavigationItem): boolean
    {
