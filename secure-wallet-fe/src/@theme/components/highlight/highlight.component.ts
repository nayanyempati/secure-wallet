...
import { ThemeHighlightService } from '@theme/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[theme-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'themeHighlight'
})
export class ThemeHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _themeHighlightService: ThemeHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._themeHighlightService.highlight(this.code, this.lang));
